...
- `high-quality`: all readable images with the versioned `high-quality-v4`
  envelope: SIFT CUDA at 4096 px and 16,384 features, 30,000 iterations,
  adaptive Gaussian capacity from 5M up to 6M according to surface/GSD/VRAM,
  projected initialization, image factor 1, and full detection; this is the
  pending BIGZEN qualification path, not a default laptop profile
