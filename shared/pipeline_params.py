...
PARAMETER_METADATA: dict[str, dict[str, Any]] = {
    ...
    "gs_backend": {"label": "GS Training Backend", "type": "select", "group": "Orthomosaic", "options": ["dronegs"]},
    ...
    "gs_optimizer_profile": {"label": "DroneGS Optimizer Profile", "type": "select", "group": "Orthomosaic", "options": ["reference-absolute", "dev38-staged-rotation008-absgrad050-fastgs", "dronegs-dev16"]},
    "gs_pruning_policy": {"label": "DroneGS Pruning Policy", "type": "select", "group": "Orthomosaic", "options": ["spatial-bounds", "original"]},
    "gs_raster_profile": {"label": "DroneGS Raster Profile", "type": "select", "group": "Orthomosaic", "options": ["bounded", "fastgs", "auto"]},
    ...
    "gs_checkpoint_every": {"label": "DroneGS Checkpoint Interval", "type": "int", "group": "Orthomosaic", "min": 0, "max": 50000, "step": 500},
    "gs_test_every": {"label": "DroneGS Held-out Split Interval", "type": "int", "group": "Orthomosaic", "min": 0, "max": 100, "step": 1},
    "gs_canary_min_psnr": {"label": "DroneGS Canary Minimum PSNR", "type": "float", "group": "Orthomosaic", "min": 0, "max": 100, "step": 0.1},
    "gs_canary_min_ssim": {"label": "DroneGS Canary Minimum SSIM", "type": "float", "group": "Orthomosaic", "min": 0, "max": 1, "step": 0.01},
