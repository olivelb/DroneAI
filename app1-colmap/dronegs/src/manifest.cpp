...
void write_completed_manifest(const Options& options, const Scene& scene,
    ...
    stream << std::setprecision(10)
           << "{\n"
           << "  \"contract_version\": 1,\n"
           << "  \"backend\": \"dronegs-mrnf-scheduled-gumbel-edge-anisotropic-dssim-prototype\",\n"
           << "  \"trainer_version\": \"0.5.0-dev.17\",\n"
           ...
           << "    \"mode\": "
              "\"mrnf-scheduled-gumbel-edge-anisotropic-geometry-dssim-held-out-ordered-alpha-prototype\"\n"
           << "  },\n"
           << "  \"timings\": {\n"
