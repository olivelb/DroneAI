...
void write_completed_manifest(const Options& options, const Scene& scene,
    ...
    stream << std::setprecision(10)
           << "{\n"
           << "  \"contract_version\": 1,\n"
           << "  \"backend\": \"dronegs-mrnf-growth-anisotropic-dssim-prototype\",\n"
           << "  \"trainer_version\": \"0.5.0-dev.15\",\n"
           ...
           << "    \"lambda_dssim\": 0.2,\n"
           << "    \"topology_growth\": "
              "\"deterministic_top_weight_long_axis_split\",\n"
           << "    \"growth_score\": "
           ...
           << "    \"growth_selection\": "
              "\"descending_weight_then_source_index\",\n"
           ...
           << "    \"mode\": "
              "\"mrnf-growth-anisotropic-geometry-dssim-held-out-ordered-alpha-prototype\"\n"
           << "  },\n"
           << "  \"timings\": {\n"
