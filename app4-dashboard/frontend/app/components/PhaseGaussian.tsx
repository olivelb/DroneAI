...
const DRONEGS_PRESETS = [
  ...
  },
  {
    id: "detailed",
    label: "Detailed",
    description: "4,096 px and adaptive capacity up to 6 M Gaussians for qualified high-memory GPUs.",
