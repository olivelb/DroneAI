...
const runtime='922269da1b037c5ff28d439b2c5a354386d036a9';
const baselineCommit='aa095acfd477e8d9875ae286424c542b766ac3ea';
...
const protocol={schema:'gstile-v4-blocked-costs-complete-build-v1',runtime,baseline:baselineCommit,
  ...
  candidateDistanceBlockRows:4096,
