...
const runtime='cfc28fbeff030e63ff238a23d80d4ffb1c47d677';
const baselineCommit='e651905f593cafe293d74d4d1ef8251e2cedd442';
...
const protocol={schema:'gstile-refit-scratch-complete-build-v1',runtime,baseline:baselineCommit,
  ...
  candidateRefitOwnedScratch:true,
