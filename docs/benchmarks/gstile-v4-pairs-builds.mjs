...
const runtime='33ab1c366d74bf8648153873b24691e45497a4bb';
const baselineCommit='9269f8ef22bbd21d1093fdb2f9be139180cad77a';
...
const protocol={schema:'gstile-v4-pairs-complete-build-v1',runtime,baseline:baselineCommit,
  ...
  acceptance:'Ten builds retained: warmups then four AB/BA pairs. Exact all-file parity; unchanged source and clean pinned reports. Median reduction >=10% and all measured pairs faster. No exclusions or cache flush.'};
...
const accepted=1-newMedian/oldMedian>=0.10&&paired.every(p=>p.reduction>0);
