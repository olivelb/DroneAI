...
| DroneGS MRNF growth, Gumbel, and edge adaptation | LichtFeld `src/training/strategies/mrnf.cpp`, `src/training/kernels/mrnf_kernels.cu`, `src/training/kernels/densification_kernels.cu`, `src/training/rasterization/edge_rasterizer.cpp`, `src/training/rasterization/edge_compute/rasterization/include/kernels_forward.cuh`, `src/training/rasterization/fastgs/rasterization/include/kernels_backward.cuh`, and `src/training/trainer.cpp` at `1004c0841a3776e3f67866ff34101fbc9677397f`; local `app1-colmap/dronegs/cuda/rasterization.cu` and `app1-colmap/dronegs/cuda/trainer.cu`, modified 2026-07-25 | GPL-3.0-or-later | Dev.15 error-map weighting, cadence, capacity growth, and split plus dev.16 weighted-Gumbel and edge-guidance behavior integrated with the native trainer | Both combined CUDA translation units carry GPL SPDX/copyright headers; distribute the resulting native binary as GPL-covered, retain this modification record, and make corresponding source available |
