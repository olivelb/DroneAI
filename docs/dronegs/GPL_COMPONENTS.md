...
| LichtFeld minimal and deterministic-replay patches | `app1-colmap/patches/lichtfeld-*.patch` | Modifications to GPL work | Headless/minimal build changes and opt-in `LFS_SAMPLER_SEED` sampling plus asynchronous-result ordering | Treat patches and resulting binary as GPL-covered modifications |
