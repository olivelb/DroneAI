...
| DroneGS MRNF growth adaptation | LichtFeld `src/training/strategies/mrnf.cpp`, `src/training/kernels/densification_kernels.cu`, `src/training/rasterization/fastgs/rasterization/include/kernels_backward.cuh`, and `src/training/trainer.cpp` at `1004c0841a3776e3f67866ff34101fbc9677397f`; local `app1-colmap/dronegs/cuda/rasterization.cu` and `app1-colmap/dronegs/cuda/trainer.cu`, modified 2026-07-25 | GPL-3.0-or-later | Dev.15 error-map weighting/normalization, refine cadence and thresholds, capacity growth, and long-axis split behavior integrated with the native trainer | Both combined CUDA translation units carry GPL SPDX/copyright headers; distribute the resulting native binary as GPL-covered, retain this modification record, and make corresponding source available |
