...
| DroneGS native trainer | `app1-colmap/dronegs/` | MIT; original DroneAI code | Fixed-topology CUDA training prototype | No LichtFeld source copied; Phase 4 JPEG, projection, rasterizer, backward, and Adam files are original; record any future adapted file separately before import |
