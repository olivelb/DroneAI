...
| DroneGS native trainer | `app1-colmap/dronegs/` | MIT; original DroneAI code | Fixed-topology ordered-alpha CUDA training prototype | No LichtFeld source copied; Phase 4 JPEG/scaled-IDCT orchestration, bounded decode queue/cache, projection, rasterizer, backward, persistent context, and Adam files are original; record any future adapted file separately before import |
