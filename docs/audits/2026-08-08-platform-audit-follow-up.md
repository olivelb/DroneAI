...
| Strict typing for `gaussian_ortho` | Confirmed absent from the current mypy ratchet. | Eleven CPU-visible modules now run under strict mypy, including explicit EXIF/GPS and CUDA model-filter boundaries. |
