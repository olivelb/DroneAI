...
| Strict typing for `gaussian_ortho` | Confirmed absent from the current mypy ratchet. | The complete 19-module package now runs under strict mypy, including explicit COLMAP binary, EXIF/GPS, Gaussian-model, CUDA-rasterizer, orthophoto-renderer and end-to-end orchestration boundaries. |
