...
| Strict typing for `gaussian_ortho` | Confirmed absent from the current mypy ratchet. | Ten CPU-visible modules now run under strict mypy, including an explicit CUDA model-filter boundary. |
